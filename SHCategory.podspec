#
#  Be sure to run `pod spec lint SHCategory.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name         = "SHCategory"
  s.version      = "0.0.1"
  s.summary      = "SHCategory by Objective-C”
  ...
  s.author             = { “Motian” => “llstc30@163.com” }
  # Or just: s.author    = ""
  # s.authors            = { "" => "" }
