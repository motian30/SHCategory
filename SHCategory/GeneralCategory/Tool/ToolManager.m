...
+ (BOOL)validateMobile:(NSString *)mobileNum{
     ...
     * 联通：130,131,132,152,155,156,183,185,186,145,176
     * 电信：133,1349,153,180,181,189,173,177
     */
    NSString * MOBILE = @"^((13[4-9])|(147)|(15[0-2,7-9])|(178)|(18[2-4,7-8]))\\d{8}|(1705)\\d{7}$";
    /**
     10         * 中国移动：China Mobile
     11         * 134[0-8],135,136,137,138,139,150,151,152,157,158,159,187,182,183,184,187,188
     12         */
    ...
    /**
     ...
     17         */
    NSString * CU = @"^1(3[0-2]|5[256]|8[356]|7[6]|4[5])\\d{8}$";
    /**
